 ...
 */
final class Version20190711030952 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE email CHANGE contenue contenue LONGTEXT NOT NULL');
        ...
        $this->addSql('DROP INDEX id ON owned_vehicles');
        $this->addSql('ALTER TABLE owned_vehicles CHANGE plate plate VARCHAR(12) NOT NULL, CHANGE id id INT NOT NULL, ADD PRIMARY KEY (plate)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE email CHANGE contenue contenue VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('CREATE UNIQUE INDEX id ON owned_vehicles (id)');
