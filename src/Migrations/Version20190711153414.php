 ...
 */
final class Version20190711153414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE extension_mail CHANGE name namet VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE extension_mail CHANGE namet name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
